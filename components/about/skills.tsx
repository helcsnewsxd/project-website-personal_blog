  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          style={{ fill: "currentColor" }}
          d="M282.156,319.661c28.8-19.6,50-49.2,58-84"
        ></path>
        <path
          style={{ fill: "currentColor" }}
          d="M282.156,327.661c-2.4,0-5.2-1.2-6.8-3.6c-2.4-3.6-1.6-8.8,2-11.2c28-18.8,47.2-47.2,54.8-79.2 c0.8-4.4,5.2-6.8,9.6-6s6.8,5.2,6,9.6c-8.4,36-30,67.6-61.2,88.8C285.356,327.261,283.756,327.661,282.156,327.661z"
        ></path>
        <path
          style={{ fill: "currentColor" }}
          d="M243.756,338.061c2.8-0.8,5.2-1.6,8-2.8"
        ></path>
        <path
          style={{ fill: "currentColor" }}
          d="M243.756,346.061c-3.6,0-6.8-2.4-7.6-6c-1.2-4.4,1.2-8.8,5.6-10c2.8-0.8,4.8-1.6,7.2-2.4 c4-1.6,8.8,0,10.4,4.4c1.6,4,0,8.8-4.4,10.4c-2.8,1.2-5.6,2-8.8,3.2C245.356,346.061,244.556,346.061,243.756,346.061z"
        ></path>
      </g>
    </svg>
  );
